    ...
    return (
        ...
        <div className="voutlet">
            ...
            <div className='content-light'>
                <MissionText>
                <br/>Here at Ark Construction Safety and Health, it is our 
                ...
                <br/>
                <br/>According to OSHA regulations, the employer is required by 
                ...
                <br/>
                <br/>Is it worth the cost of not treating safety as an investment?  We are 
